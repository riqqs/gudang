                ...
                <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Real Stok</th>
                    ...
                    <tbody>
                        ...
                        // SQL query to fetch barang details with incoming stock sum
                        $query = mysqli_query($mysqli, "
    SELECT a.id_barang, a.nama_barang, a.material_number, a.stok,
           IFNULL(SUM(c.jumlah), 0) AS jumlah
    FROM tbl_barang a
    LEFT JOIN tbl_incoming_stock c ON a.id_barang = c.id_barang
...
<tr>
    ...
    <td width="200"><?php echo $data['material_number']; ?></td>
    <td width="50" class="text-right"><?php echo $data['stok']; ?></td>
    <td width="40" class="text-right"><?php echo $data['jumlah']; ?></td>
