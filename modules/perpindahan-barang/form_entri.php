...
?>
                            ...
                            <div class="input-group">
                                <input type="text" name="id_permintaan" class="form-control"
                                    value="<?php echo $id_permintaan; ?>" readonly>
...
$(document).ready(function() {
    ...
    $('#addItem').click(function() {
        ...
        if (!id_barang || !jumlah || jumlah <= 0) {
            $('#pesan').html(
                '<div class="alert alert-warning">Silakan isi data barang dan jumlah dengan benar.</div>'
                );
            return;
        }
    ...
    $('#confirmSave').click(function() {
        ...
        var formData = $('#entryForm').serialize() + '&keterangan=' + encodeURIComponent(keterangan) +
